      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <Link href="/blog" className="px-3 py-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700">
              Blog
            </Link>
            <Link href="/projects" className="px-3 py-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700">
              Proyectos
            </Link>
            <Link href="/about" className="px-3 py-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700">
              Sobre mí
            </Link>
            <Link href="/contact" className="px-3 py-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700">
              Contacto
            </Link>
